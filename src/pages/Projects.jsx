      ...
      <div className="box-with-projects">
        <div className="project">
          ...
          <div className="description">
            ...
            <p>
              Сайт для удобного изучения JavaScript. Включает охватывающие ключевые аспекты языка, оформленный для лёгкого восприятия.
              Адаптивная навигация автоматически подстраивается под размер экрана.
            </p>
            <p className="title">Почему это полезно?</p>
            <p>
              Сайт можно адаптировать под любые задачи. Такой инструмент поможет структурировать
        ...
        <div className="project">
          ...
          <div className="description">
            ...
            <p>
              ...
              ценами, а также включает галерею работ мастеров. Адаптивный дизайн, что позволяет клиентам легко
        ...
        <div className="project">
          ...
          <div className="description">
            ...
            <p>
              Одностраничный сайт, посвящённый Мухамеду Али, с
            ...
            <p>
              ...
              конспектов лекций, учебных заметок, или
              справочников, делая информацию доступной и понятной.
            </p>
          </div>
          <div className="button-section">
        ...
        <div className="project">
          ...
          <div className="description">
            ...
            <p>
              Развлекательное приложение "Машина цитат" с
              минималистичным дизайном. В нём собраны вдохновляющие и мудрые цитаты от
              великих людей, которые могут поднять настроение или стать
              источником мотивации.
            </p>
            <p>
              Можно адаптировать этот проект для создания карточек для
              изучения языков, что сделает его полезным инструментом для
              обучения. Это идеальный проект для создания простого, но функционального
        ...
        <div className="project">
          ...
          <div className="description">
            ...
            <p>
              Проект представляет собой две доски, одна из которых
              предназначена для ввода текста в формате Markdown, а вторая — для
              отображения того, как будет выглядеть результат. Простой и
              интуитивно понятный интерфейс. Идеально
              подходит для изучения и практики работы с Markdown языком разметки.
            </p>
            <p>
              Проект является отличным инструментом для тех, кто хочет
              улучшить свои навыки работы с Markdown.
            </p>
          </div>
          <div className="button-section">

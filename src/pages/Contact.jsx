  ...
  return (
    <main className="container-contact">
      ...
      <div className="advertising-text">
        ...
        <p>Если вам <span>нужен</span> современный <span>сайт</span>, я готов помочь с:</p>
        <ul>
          <li>
        ...
        <p>
          Также я <span>открыт к предложениям</span> о сотрудничестве в роли
          <span> фронтенд-разработчика</span> или <span>HTML-верстальщика</span>.
        </p>
        <p>Буду рад обсудить ваш <span>проект</span> или ответить на <span>вопросы</span>!</p>
      </div>
    </main>
  );
}
